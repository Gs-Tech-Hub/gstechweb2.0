        ...
        <main className='pt-[4rem] pb-[1rem] px-[1rem] '>
            <div className='flex items-start justify-around'>
                <div>
                    ...
                    <button className='cursor-pointer primaryColor text-[white] outline-none rounded-[0.2rem] px-[1.6rem] py-[0.58rem] mt-[1rem] font-bold text-[1.5rem]'>Get started</button>
                </div>
