            ...
            <div className='flex items-start justify-evenly pb-[2rem] max-[839px]:flex-wrap'>
                ...
                <div className='max-[839px]:w-[40%] max-[839px]:mb-[2rem] max-[740px]:w-[47%]'>
                    ...
                    <div className='flex items-center rounded-[2rem] w-[20rem] px-[0.35rem] bg-[white] text-[black] py-[0.3rem] max-[740px]:w-[95%]'>
                        <input type='email' placeholder='Email address' value={email} onInput={(e) => setemail(e.target.value)} className=' outline-none pl-[0.7rem] py-[0.4rem] w-[90%] m-[auto] ' />
                        <button onClick={handleButton} className='cursor-pointer bg-black text-[white] outline-none rounded-[2rem] px-[1.6rem] py-[0.25rem] text-[1.1rem] max-[740px]:px-[0.8rem]'>Submit</button>
