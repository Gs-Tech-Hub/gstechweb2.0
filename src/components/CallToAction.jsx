    ...
    return (
        <div className='text-center py-[3rem] max-[480px]:px-[0.5rem]'>
            ...
            <div className='flex items-center justify-center mb-[1rem] max-[344px]:block'>
                ...
                <button className='cursor-pointer rounded-[2rem] ml-[2rem] border-[1px] border-[orange] text-[orange] outline-none px-[1.6rem] py-[0.58rem] mt-[1rem] font-bold text-[1.5rem] max-[770px]:text-[1.3rem] max-[560px]:ml-[1rem] max-[490px]:px-[1rem] max-[400px]:text-[1.12rem] max-[344px]:w-[90%]'><Link to='/Portfolio'>View Portfolio</Link></button>
            </div>
        </div>
    )
}
