                ...
                <div>
                    <div className="mx-[auto] w-[70%] max-[807px]:w-[85%] max-[657px]:w-[90%]">
                        ...
                        <div className='text-end'>
                            <button className='cursor pointer primaryColor text-[white] outline-none rounded-[0.3rem] px-[0.6rem] w-[11rem] py-[0.5rem] text-[1.1rem] font-bold max-[427px]:mt-[2rem] max-[360px]:w-[100%]'>Submit</button>
                        </div>
                    </div>
                </div>
            </div>
