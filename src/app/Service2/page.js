...
const page = () => {
    return (
        <div>
            <div>
                <h1 className='font-bold text-[1.7rem] text-center pt-[1rem] mb-[3.3rem] max-[479px]:text-[1.55rem] max-[479px]:px-[1rem]'>Enterprise Management Solutions</h1>
                    ...
                    <div className='w-[40%] mx-[auto] max-[1096px]:w-[50%] max-[956px]:w-[95%]'>
                        ...
                        <div className='flex items-start justify-evenly  flex-wrap'>
                            <div className='w-[40%] mb-[2rem]'>
                                ...
                                <h2 className='font-bold text-[1.45rem]  mb-[0rem] max-[479px]:text-[1.2rem]'>Customer Relationship <br />Management (CRM)</h2>
                                <p className='text-[1.2rem] max-[479px]:text-[1.1rem] max-[397px]:text-[1.03rem]'>Track interactions and manage customer retention.</p>
                            </div>
                            <div className='w-[40%] mb-[2rem]'>
                                ...
                                <h2 className='font-bold text-[1.45rem]  mb-[0rem] max-[479px]:text-[1.2rem]'>Inventory & Supply <br /> Chain Management</h2>
                                <p className='text-[1.2rem] max-[479px]:text-[1.1rem] max-[397px]:text-[1.03rem]'>Optimize stock levels and streamline procurment.</p>
                            </div>
                            <div className='w-[40%] mb-[2rem]'>
                                ...
                                <h2 className='font-bold text-[1.45rem]  mb-[0rem] max-[479px]:text-[1.2rem]'>Financial & <br />Accounting Tools</h2>
                                <p className='text-[1.2rem] max-[479px]:text-[1.1rem] max-[397px]:text-[1.03rem]'>Automated billing, invoicing and reporting</p>
                            </div>
                            <div className='w-[40%] mb-[2rem]'>
                                ...
                                <h2 className='font-bold text-[1.45rem]  mb-[0rem] max-[479px]:text-[1.2rem]'>Human Resource <br />Management (HRM)</h2>
                                <p className='text-[1.2rem] max-[479px]:text-[1.1rem] max-[397px]:text-[1.03rem]'>Payrole, schedulling and employee tracking</p>
                            </div>
                        </div>
                    </div>
