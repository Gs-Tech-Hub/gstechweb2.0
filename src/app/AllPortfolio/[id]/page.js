        ...
        <div>
            <div className='w-[95%] m-[auto] pt-[2rem]'>
                ...
                <div className='mb-[1rem]'>
                    <h3 className='mb-[0.5rem] font-bold ' >Client </h3>
                    <p>F-MMM1 Hotel</p>
                </div>
                <div className='mb-[1rem]'>
                    <h3 className='mb-[0.5rem] font-bold max-[636px]:mb-[1.2rem]' >Client Socials</h3>
                    <div className='flex items-center max-[636px]:block '>
                        <div className='flex items-center max-[636px]:mb-[1rem]'>
                            <FaGlobeAmericas className='mr-[0.24rem]' size={22} />
                            <a href='https://f-mmm1hotel.nl'>https://f-mmm1hotel.nl</a >
                        </div>
                        <div className='w-[1px] mx-[1.5rem] h-[1.1rem] border-[1px] border-[#3a3535] max-[729px]:mx-[0.5rem] max-[636px]:hidden'></div>
                        <div className='flex items-center max-[636px]:mb-[1rem]'>
